            ...
            <ul className="space-y-4">
              {s.contact_phone && (
                <li className="flex items-start gap-3 text-sm text-[var(--gray-400)]">
                  ...
                  <a href={`tel:${s.contact_phone}`} className="hover:text-[var(--teal)] transition-colors">{s.contact_phone}</a>
                </li>
              )}
              {s.contact_email && (
                <li className="flex items-start gap-3 text-sm text-[var(--gray-400)]">
                  ...
                  <a href={`mailto:${s.contact_email}`} className="hover:text-[var(--teal)] transition-colors break-all">{s.contact_email}</a>
                </li>
              )}
              {s.contact_address && (
                <li className="flex items-start gap-3 text-sm text-[var(--gray-400)]">
