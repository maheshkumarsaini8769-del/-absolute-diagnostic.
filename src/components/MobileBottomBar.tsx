  ...
  const items = [
    {
      ...
      label: 'Book Test',
      icon: (active: boolean) => (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? 'var(--blue)' : '#64748B'} strokeWidth="2" strokeLinecap="round">
          ...
          return (
            <Tag
              ...
              className={`flex flex-col items-center justify-center py-2 px-1 transition-all duration-200 ${
                isActive ? 'text-[var(--blue)] font-bold' : 'text-slate-600 font-medium hover:text-slate-900'
              }`}
