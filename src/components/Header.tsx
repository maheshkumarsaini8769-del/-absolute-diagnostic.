...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <Link
              href="/reports"
              className="text-sm font-medium text-[var(--gray-600)] hover:text-[var(--navy)] transition-colors px-4 py-2"
            >
              View Reports
            </Link>
            <Link
              href="/booking"
              className="btn-primary text-sm px-5 py-2.5 rounded-full inline-flex items-center gap-2"
            >
      ...
      <div
        className={`fixed top-0 right-0 h-full w-[320px] max-w-[85vw] z-50 transform transition-transform duration-500 lg:hidden ${
      ...
      >
        <div className="h-full bg-white shadow-2xl shadow-black/20 flex flex-col">
          ...
          <div className="p-4 border-t border-[var(--gray-100)] space-y-3">
            <a href="tel:" className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-[var(--gray-700)] hover:text-[var(--blue)] transition-colors rounded-xl hover:bg-[var(--gray-50)]">
              <div className="w-9 h-9 rounded-lg bg-[var(--blue)]/10 flex items-center justify-center">
            ...
            <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-[var(--gray-700)] hover:text-green-600 transition-colors rounded-xl hover:bg-[var(--gray-50)]">
            ...
            <Link href="/booking" className="flex items-center justify-center gap-2 w-full btn-primary text-sm rounded-xl py-3">
              <span className="flex items-center gap-2">
