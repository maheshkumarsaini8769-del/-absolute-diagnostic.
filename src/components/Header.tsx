      ...
      >
        <div className="h-full bg-white shadow-2xl shadow-black/20 flex flex-col">
          ...
          <div className="p-3 border-t border-[var(--gray-100)] space-y-2 shrink-0">
            ...
            <Link href="/booking" className="flex items-center justify-center gap-2 px-3 py-2 rounded-full bg-purple-500/10 text-purple-300 text-sm font-medium transition-all hover:bg-purple-500/20 rounded-xl">
              <span className="flex items-center gap-2">
