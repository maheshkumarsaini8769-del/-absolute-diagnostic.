  ...
  return (
    <HomepageAnimations>
      ...
      <section className="relative overflow-hidden">
        {/* Pathologist & Reports Background Image */}
        <div className="absolute inset-0 z-0">
          <img 
            src="/images/hero/hero-reports.webp" 
            alt="Patient Diagnostic Reports Portal" 
            fetchPriority="high"
            decoding="async"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <nav className="flex items-center gap-2 text-sm text-slate-400 mb-6">
            ...
            <span className="text-white">Diagnostic Reports</span>
          </nav>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-3" style={{ fontFamily: 'var(--font-jakarta)' }}>
            Patient Portal &amp; <span className="gradient-text">Reports</span>
          </h1>
          <p className="text-slate-300 text-base max-w-xl leading-relaxed">
            Secure, encrypted access to your clinical pathology, diagnostic reports, and MD pathologist verified findings.
          </p>
        </div>
